...
from dataset_resize import DatasetStg1
import monai
...
def get_arguments():
    ...
    parser.add_argument('--transform', type=str, default="no_resize", help="[no_resize|crop1|crop2|crop3|crop4]")
...
def main():
    ...
    testdataset = DatasetStg1(TEST_PATH, istranform=False, monai_transform="no_resize")
    ...
    logging.info(f"Input Resized Shape = {traindataset[0][0].shape}")
